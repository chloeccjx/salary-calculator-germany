...
"Bauleiter": {
        ...
        "Hamburg": (55500, 75000),
        "Munich": (55500, 75000),
        "Regional (rest of Germany)": (55500, 75000),
    },
    "Glasfasermonteur": {
        "Berlin": (42000, 50650),
        "Frankfurt": (42000, 50650),
        "Hamburg": (42000, 50650),
        "Munich": (42000, 50650),
        "Regional (rest of Germany)": (42000, 50650),
    },
    "Projektleiter": {
        "Berlin": (65000, 90000),
        "Frankfurt": (65000, 90000),
        "Hamburg": (65000, 90000),
        "Munich": (65000, 90000),
        "Regional (rest of Germany)": (65000, 90000),
    },
    "Netzplaner": {
        "Berlin": (49500, 65000),
        "Frankfurt": (49500, 65000),
        "Hamburg": (49500, 65000),
        "Munich": (49500, 65000),
        "Regional (rest of Germany)": (49500, 65000),
    },
    "Senior Projektleiter": {
        "Berlin": (85000, 100000),
        "Frankfurt": (85000, 100000),
        "Hamburg": (85000, 100000),
        "Munich": (85000, 100000),
        "Regional (rest of Germany)": (85000, 100000),
    },
    "Head of Deployment": {
        "Berlin": (100000, 120000),
        "Frankfurt": (100000, 120000),
        "Hamburg": (100000, 120000),
        "Munich": (100000, 120000),
        "Regional (rest of Germany)": (100000, 120000),
    },
    "Oberbauleiter": {
        "Berlin": (80500, 95000),
        "Frankfurt": (80500, 95000),
        "Hamburg": (80500, 95000),
        "Munich": (80500, 95000),
        "Regional (rest of Germany)": (80500, 95000),
    },
    "Projektassistentin": {
        "Berlin": (45500, 55000),
        "Frankfurt": (45500, 55000),
        "Hamburg": (45500, 55000),
        "Munich": (45500, 55000),
        "Regional (rest of Germany)": (45500, 55000),
    },
    "Genehmigungsplaner": {
        "Berlin": (42100, 50000),
        "Frankfurt": (42100, 50000),
        "Hamburg": (42100, 50000),
        "Munich": (42100, 50000),
        "Regional (rest of Germany)": (42100, 50000),
    },
}
